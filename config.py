...
# Dataset (choose one).
desc += '-wsi';                 dataset = EasyDict(tfrecord_dir='/hdd/WSI_data/VAE-GAN-Data/'); train.mirror_augment = True
...
#train = EasyDict(func='util_scripts.generate_interpolation_video', run_id=10, grid_size=[1,1], duration_sec=60.0, smoothing_sec=1.0); num_gpus = 1; desc = 'interpolation-video-' + str(train.run_id)
