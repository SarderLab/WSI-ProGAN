...
class TrainingSchedule:
    def __init__(
        ...
        cur_nimg,
        training_set,
        lod_initial_resolution  = 512,        # Image resolution used at the beginning.
        lod_training_kimg       = 600/2,      # Thousands of real images to show before doubling the resolution.
        lod_transition_kimg     = 600/2,      # Thousands of real images to show when fading in new layers.
        ...
        tick_kimg_base          = 60,      # Default interval of progress snapshots.
        tick_kimg_dict          = {4: 160/2, 8:140/2, 16:120/2, 32:100/2, 64:80/2, 128:5, 256:4, 512:3, 1024:10/2}): # Resolution-specific overrides.
...
def train_progressive_gan(
    ...
    total_kimg              = 15000/2,        # Total length of the training, measured in thousands of real images.
    ...
    resume_run_id           = '010-pgan-wsi-preset-v2-1gpu-fp16',         # Run ID or network pkl to resume training from, None = start from scratch.
    resume_snapshot         = None,         # Snapshot index to resume training from, None = autodetect.
    resume_kimg             = 800.0,          # Assumed training progress at the beginning. Affects reporting and training schedule.
